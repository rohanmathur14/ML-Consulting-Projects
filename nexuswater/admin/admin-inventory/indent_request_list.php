                            ...
                            <div class="box border blue">
                                ...
                                <div class="box-body">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-primary" onClick="$('#search').val('1');document.pagination_form.action='<?php echo base_url();?>admin/inventory/indent_request';"><i class="fa fa-search"></i> Search</button>
                                                <a href="<?php echo $site_path['admin_url']; ?>inventory/indent_request"><button class="btn btn-inverse" type="button">Show All</button></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box border blue">
                                        <div class="box-title">
                                            ...
                                            <a href="<?php echo $site_path['admin_url']; ?>inventory/make_indent_request" class="btn btn-primary" style="float: right;padding:1px 12px;">Request</a>
                                        </div>
                                    <div class="box-body">
