                                ...
                                <div class="tabbable header-tabs user-profile">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade in active" id="personal_information">
                                            <div class="box-body ">
                                                <form enctype="multipart/form-data" method="post" name="addI" id="addI" action="<?php echo $site_path['admin_url']; ?>inventory/i_add/<?php echo $dbdata['id'];?>"  class="form-horizontal">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" name="i_quantity" id="i_quantity" class="form-control number" >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" name="bill_voucher_no" id="bill_voucher_no" class="form-control" autocomplete="off">
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2">
                                                            <input type="text" name="received_by" id="received_by" class="form-control" autocomplete="off">
                                                        </div>
                                                    </div>
            ...
            fields: {
                i_quantity: {
                    validators: {
                        ...
                        between: {
                            min: 0,
                            max: <?php echo $dbdata['s_quantity'];?>,
                            message: 'You can\'t enter quantity more than <?php echo $dbdata['s_quantity'];?>'
                        }
                    }
                }
            }
