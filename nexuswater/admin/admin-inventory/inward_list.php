                                ...
                                <div class="box-body">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" placeholder="Invoice No" class="form-control"  maxlength="255"  value="<?php if(isset($FormData['s_invoice_no']) && !empty($FormData['s_invoice_no'])){echo $FormData['s_invoice_no'];} ?>" name="FormData[s_invoice_no]" id="s_invoice_no" autocomplete="off">
                                            </div>

                                            <label class="col-sm-1 control-label">E-Way Bill No</label>
                                            <div class="col-sm-2">
                                                <input type="text" placeholder="E-Way Bill No" class="form-control"  maxlength="255"  value="<?php if(isset($FormData['s_eway_bill_no']) && !empty($FormData['s_eway_bill_no'])){echo $FormData['s_eway_bill_no'];} ?>" name="FormData[s_eway_bill_no]" id="s_eway_bill_no" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" placeholder="Receipt No" class="form-control"  maxlength="255"  value="<?php if(isset($FormData['receipt_no']) && !empty($FormData['receipt_no'])){echo $FormData['receipt_no'];} ?>" name="FormData[receipt_no]" id="receipt_no" autocomplete="off">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-primary" onClick="$('#search').val('1');document.pagination_form.action='<?php echo base_url();?>admin/inventory/inward';"><i class="fa fa-search"></i> Search</button>
                                                <a href="<?php echo $site_path['admin_url']; ?>inventory/inward"><button class="btn btn-inverse" type="button">Show All</button></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box border blue">
                                        <div class="box-title">
                                            ...
                                            <a href="<?php echo $site_path['admin_url']; ?>inventory/i_search" class="btn btn-primary" style="float: right;padding:1px 12px;">Inward</a>
                                        </div>
                                    <div class="box-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-sm">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><a href="javascript:void(0);" onClick="return sortList('i.created_at');">Date</a></th>
                                                        <th><a href="javascript:void(0);" onClick="return sortList('i.created_at');">Receipt No</a></th>
                                                        <th><a href="javascript:void(0);" onClick="return sortList('i.user_id');">Added By</a></th>
                                                        <th><a href="javascript:void(0);" onClick="return sortList('p.name');">Project</a></th>
                                                        <th width="30%"><a href="javascript:void(0);" onClick="return sortList('mr.item_description');">Material Description</a></th>
                                                        <th><a href="javascript:void(0);" onClick="return sortList('i.i_quantity');">Quantity</a></th>
                                                        <th><a href="javascript:void(0);" onClick="return sortList('i.received_by');">Received By</a></th>
                                                        <th><a href="javascript:void(0);">Attachment</a></th>
                                                    ...
                                                    <?php
                                                        ...
                                                        for ($i = 0; $i < count($dbdata); $i++) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="row" align="left"><?php echo $dbdata[$i]['receipt_no']; ?></td>
                                                                ...
                                                                <td class="row" align="left">
                                                                    <?php
                                                                    echo $dbdata[$i]['i_quantity'];
                                                                    echo !empty($dbdata[$i]['unit_type_name']) ? " ".$dbdata[$i]['unit_type_name'] : '';
                                                                    ?>
                                                                </td>
                                                                <td class="row" align="left">
                                                                    <?php
                                                                    echo !empty($dbdata[$i]['received_by']) ? " ".$dbdata[$i]['received_by'] : 'N/A';
                                                                    ?>
                                                                </td>
                                                                <td class="row" align="left">
                                                                    Invoice No: <?php echo $dbdata[$i]['s_invoice_no'];?><br>
                                                                    E-Way Bill No: <?php echo $dbdata[$i]['s_eway_bill_no'];?><br>
                                                                    Bill Voucher No: <?php echo $dbdata[$i]['bill_voucher_no'];?><br>
                                                                    <?php
                                                                    if(!empty($dbdata[$i]['bill_voucher_no_doc']))
                                                                        {
                                                                            ?>
                                                                            <a href="<?php echo BASE_URL;?>upload/files/<?php echo $dbdata[$i]['bill_voucher_no_doc'];?>" target="_blank"  class="tip" data-original-title="<?php echo $dbdata[$i]['bill_voucher_no_doc'];?>">
                                                                ...
                                                                <td>
                                                                    <a class="tip" data-original-title="Edit" href="<?php echo $site_path['admin_url']; ?>inventory/i_edit/<?php echo $dbdata[$i]['id'];?>"><i class="fa fa-pencil-square-o fa-1x "></i></a>&nbsp;
