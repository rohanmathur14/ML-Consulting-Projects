                            ...
                            <div class="box border blue">
                                ...
                                <div class="box-body">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-primary" onClick="$('#search').val('1');document.pagination_form.action='<?php echo base_url();?>admin/inventory/material_request';"><i class="fa fa-search"></i> Search</button>
                                                <a href="<?php echo $site_path['admin_url']; ?>inventory/material_request"><button class="btn btn-inverse" type="button">Show All</button></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box border blue">
                                        <div class="box-title">
                                            ...
                                            <a href="<?php echo $site_path['admin_url']; ?>inventory/mr_add" class="btn btn-primary" style="float: right;padding:1px 12px;">Request</a>
                                        </div>
                                    <div class="box-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-sm">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><a href="javascript:void(0);" onClick="return sortList('mr.created_at');">Date</a></th>
                                                        <th><a href="javascript:void(0);" onClick="return sortList('mr.user_id');">Added By</a></th>
                                                        <th><a href="javascript:void(0);" onClick="return sortList('p.name');">Project</a></th>
                                                        <th><a href="javascript:void(0);" onClick="return sortList('u_pm.name');">Project Manager</a></th>
                                                        <th><a href="javascript:void(0);" onClick="return sortList('u_store.name');">Store In-charge</a></th>
                                                        <th><a href="javascript:void(0);" onClick="return sortList('mr.item_description');">Material Description</a></th>
                                                        <th><a href="javascript:void(0);" onClick="return sortList('mr.required_qty');">Required Quantity</a></th>
                                                        <th><a href="javascript:void(0);" onClick="return sortList('boq.boq_item');">BOQ Item</a></th>
                                                    ...
                                                    <?php
                                                        ...
                                                        for ($i = 0; $i < count($dbdata); $i++) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="row" align="left">
                                                                    <?php
                                                                    if(!empty($dbdata[$i]['project_manager_name']))
                                                                    {
                                                                        ?>
                                                                        <a href="javascript:void(0);" class="tip" data-original-title="<?php echo $dbdata[$i]['project_manager_name'];?>" title="<?php echo $dbdata[$i]['project_manager_name'];?>"><?php echo strWordCut($dbdata[$i]['project_manager_name'],20);?><br><?php echo $dbdata[$i]['pm_phone_number'];?></a>
                                                                    <?php
                                                                    }
                                                                    else
                                                                    {
                                                                ...
                                                                <td class="row" align="left">
                                                                    <?php
                                                                    if(!empty($dbdata[$i]['store_incharge_name']))
                                                                    {
                                                                        ?>
                                                                        <a href="javascript:void(0);" class="tip" data-original-title="<?php echo $dbdata[$i]['store_incharge_name'];?>"  title="<?php echo $dbdata[$i]['store_incharge_name'];?>"><?php echo strWordCut($dbdata[$i]['store_incharge_name'],20);?><br><?php echo $dbdata[$i]['store_phone_number'];?></a>
                                                                    <?php
                                                                    }
                                                                    else
                                                                    {
                                                                ...
                                                                <td class="row" align="left">
                                                                    <?php
                                                                    if(!empty($dbdata[$i]['boq_item_code']))
                                                                    {
                                                                        $boq = $dbdata[$i]['boq_item_code']." (".$dbdata[$i]['boq_item_heading'].")";
                                                                        ?>
                                                                        <a href="javascript:void(0);" class="tip" data-original-title="<?php echo $boq;?>" title="<?php echo $boq;?>"><?php echo strWordCut($boq,20);?></a>
                                                                    <?php
                                                                    }
                                                                    else
                                                                    {
                                                                ...
                                                                <td>
                                                                    <a class="tip" data-original-title="Edit" href="<?php echo $site_path['admin_url']; ?>inventory/mr_edit/<?php echo $dbdata[$i]['id'];?>"><i class="fa fa-pencil-square-o fa-1x "></i></a>&nbsp;
