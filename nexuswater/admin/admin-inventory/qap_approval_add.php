                        ...
                        <div class="col-sm-12">
                            <div class="page-header">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li><a href="<?php echo $site_path['admin_url']; ?>/inventory/qap_approval">QAP Approval</a> </li>
                                ...
                                <div class="tabbable header-tabs user-profile">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade in active" id="personal_information">
                                            <div class="box-body ">
                                                <form enctype="multipart/form-data" method="post" name="addQAP" id="addQAP" action="<?php echo $site_path['admin_url']; ?>inventory/qap_add"  class="form-horizontal">
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        function getMrData(projectId)
            {
                ...
                $('#project_manager,#store_manager,#required_qty,#unit_type,#boq_item,#vendor_name').html('N/A');
        ...
        $('#item_description_ele').on('select2:select', function (e) {
            ...
            $('#addQAP').bootstrapValidator('revalidateField','item_description_id');
        });
