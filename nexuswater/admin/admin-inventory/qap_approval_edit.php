                                    ...
                                    <div class="tabbable header-tabs user-profile">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade in active" id="personal_information">
                                                <div class="box-body ">
                                                    <form enctype="multipart/form-data" method="post" name="addVa" id="addVa" action="<?php echo $site_path['admin_url']; ?>inventory/qap_edit/<?php echo $dbdata['id'];?>"  class="form-horizontal">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4 mr_t">
                                                                <?php echo !empty($dbdata['vendor_name']) ? $dbdata['vendor_name'] : 'N/A';?>
                                                            </div>
                                                        </div>
