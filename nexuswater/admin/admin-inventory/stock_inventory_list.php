                            ...
                            <div class="dashbox panel panel-default">
                                <a href="<?php echo BASE_URL; ?>admin/inventory/stock_inventory">
                                    <div class="panel-body inventory_box">
                                        <div class="title_hr">DAILY STOCKTAKE</div>
                                    </div>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="box border blue">
                                ...
                                <div class="box-body">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-primary" onClick="$('#search').val('1');document.pagination_form.action='<?php echo base_url();?>admin/inventory/stock_inventory';"><i class="fa fa-search"></i> Search</button>
                                                <a href="<?php echo $site_path['admin_url']; ?>inventory/stock_inventory"><button class="btn btn-inverse" type="button">Show All</button></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-sm">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><a href="javascript:void(0);">Stock Item</a></th>
                                                        <th><a href="javascript:void(0);">Intial Stock</a></th>
                                                        <th><a href="javascript:void(0);">Stock In</a></th>
                                                        <th><a href="javascript:void(0);">Stock Out</a></th>
                                                        <th><a href="javascript:void(0);">Final Stock</a></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <?php if ($dbdata == false) {
