                                ...
                                <div class="tabbable header-tabs user-profile">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade in active" id="personal_information">
                                            <div class="box-body ">
                                                <form enctype="multipart/form-data" method="post" name="addS" id="addS" action="<?php echo $site_path['admin_url']; ?>inventory/s_add/<?php echo $dbdata['id'];?>"  class="form-horizontal">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2 mr_t">
                                                            <?php
                                                            $remaining_qty = ($dbdata['quantity']-$dbdata['supply_qty']);
                                                            echo $remaining_qty;
                                                            ?>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" name="s_invoice_no" id="s_invoice_no" class="form-control" autocomplete="off">
                                                        </div>

                                                        <label class="col-md-2 control-label">E-Way Bill No</label>
                                                        <div class="col-md-2">
                                                            <input type="text" name="s_eway_bill_no" id="s_eway_bill_no" class="form-control" autocomplete="off">
                                                        </div>
                                                    </div>
