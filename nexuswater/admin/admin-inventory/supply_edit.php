                                    ...
                                    <div class="tabbable header-tabs user-profile">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade in active" id="personal_information">
                                                <div class="box-body ">
                                                    <form enctype="multipart/form-data" method="post" name="addS" id="addS" action="<?php echo $site_path['admin_url']; ?>inventory/s_edit/<?php echo $dbdata['id'];?>"  class="form-horizontal">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-2 mr_t">
                                                                <?php
                                                                $remaining_qty = ($dbdata['opDetail']['quantity']-($dbdata['opDetail']['supply_qty']-$dbdata['s_quantity']));
                                                                echo $remaining_qty;
                                                                ?>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <input type="text" name="quantity" id="quantity" class="form-control number" value="<?php echo $dbdata['s_quantity'];?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <textarea name="remarks" id="remarks" class="form-control" ><?php echo $dbdata['remarks'];?></textarea>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <input type="text" name="s_invoice_no" id="s_invoice_no" class="form-control" autocomplete="off" value="<?php echo $dbdata['s_invoice_no'];?>">
                                                            </div>

                                                            <label class="col-md-2 control-label">E-Way Bill No</label>
                                                            <div class="col-md-2">
                                                                <input type="text" name="s_eway_bill_no" id="s_eway_bill_no" class="form-control" autocomplete="off" value="<?php echo $dbdata['s_eway_bill_no'];?>">
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label">Attach Copy of way-Bill Bilty etc</label>
                                                            <div class="col-md-5">
                ...
                quantity: {
                    validators: {
                        ...
                        between: {
                            ...
                            message: 'You can\'t enter quantity more than <?php echo $remaining_qty;?>'
                        }
                    }
                },
                s_invoice_no: {
