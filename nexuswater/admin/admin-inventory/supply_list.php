                            ...
                            <div class="box border blue">
                                ...
                                <div class="box-body">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-primary" onClick="$('#search').val('1');document.pagination_form.action='<?php echo base_url();?>admin/inventory/supply';"><i class="fa fa-search"></i> Search</button>
                                                <a href="<?php echo $site_path['admin_url']; ?>inventory/supply"><button class="btn btn-inverse" type="button">Show All</button></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box border blue">
                                        <div class="box-title">
                                            ...
                                            <a href="<?php echo $site_path['admin_url']; ?>inventory/s_search" class="btn btn-primary" style="float: right;padding:1px 12px;">Supply Placement</a>
                                        </div>
                                    <div class="box-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-sm">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><a href="javascript:void(0);" onClick="return sortList('s.created_at');">Date</a></th>
                                                        <th><a href="javascript:void(0);" onClick="return sortList('s.user_id');">Added By</a></th>
                                                        ...
                                                        <th><a href="javascript:void(0);" onClick="return sortList('s.s_quantity');">Quantity</a></th>
                                                    ...
                                                    <?php
                                                        ...
                                                        for ($i = 0; $i < count($dbdata); $i++) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a class="tip" data-original-title="Edit" href="<?php echo $site_path['admin_url']; ?>inventory/s_edit/<?php echo $dbdata[$i]['id'];?>"><i class="fa fa-pencil-square-o fa-1x "></i></a>&nbsp;
