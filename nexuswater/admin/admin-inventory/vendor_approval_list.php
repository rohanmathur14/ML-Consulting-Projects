                            ...
                            <div class="box border blue">
                                ...
                                <div class="box-body">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-primary" onClick="$('#search').val('1');document.pagination_form.action='<?php echo base_url();?>admin/inventory/vendor_approval';"><i class="fa fa-search"></i> Search</button>
                                                <a href="<?php echo $site_path['admin_url']; ?>inventory/vendor_approval"><button class="btn btn-inverse" type="button">Show All</button></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box border blue">
                                        <div class="box-title">
                                            ...
                                            <a href="<?php echo $site_path['admin_url']; ?>inventory/va_add" class="btn btn-primary" style="float: right;padding:1px 12px;">Request</a>
                                        </div>
                                    <div class="box-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-sm">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><a href="javascript:void(0);" onClick="return sortList('va.created_at');">Date</a></th>
                                                        <th><a href="javascript:void(0);" onClick="return sortList('va.user_id');">Added By</a></th>
                                                        ...
                                                        <th><a href="javascript:void(0);" onClick="return sortList('mr.required_qty');">Approved Quantity</a></th>
                                                        <th><a href="javascript:void(0);">Attached Credentials</a></th>
                                                        <th><a href="javascript:void(0);">Approval Copy</a></th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="row" align="left">
                                                                    ...
                                                                    if($dbdata[$i]['status']=='1') {
                                                                        echo $dbdata[$i]['approved_quantity'];
                                                                        echo !empty($dbdata[$i]['unit_type_name']) ? " " . $dbdata[$i]['unit_type_name'] : '';
                                                                    }
                                                                    else{
                                                                        echo "N/A";
                                                                ...
                                                                <td class="row" align="left">
                                                                    <?php
                                                                    if(!empty($dbdata[$i]['approved_attachment']))
                                                                    {
                                                                        ?>
                                                                        <a href="<?php echo BASE_URL;?>upload/files/<?php echo $dbdata[$i]['approved_attachment'];?>" target="_blank"  class="tip" data-original-title="<?php echo $dbdata[$i]['approved_attachment'];?>">
                                                                            <?php //echo $dbdata[$i]['attachment'];?> <i class="fa fa-download" aria-hidden="true"></i>
                                                                        </a>
                                                                    <?php
                                                                    }
                                                                ...
                                                                <td>
                                                                    <a class="tip" data-original-title="Edit/Approve" href="<?php echo $site_path['admin_url']; ?>inventory/va_edit/<?php echo $dbdata[$i]['id'];?>"><i class="fa fa-pencil-square-o fa-1x "></i></a>&nbsp;
