var App = function () {
	...
	var handleRaty = function () {
		$.fn.raty.defaults.path = siteUrl+'js/admin/jquery-raty/img';
		...
		$('#starHalf-demo').raty({
			path    : siteUrl+'js/admin/jquery-raty/img',
			half    : true,
	...
	var handleBackstretch = function () {
		 $.backstretch([
             siteUrl+"images/admin/login/1.jpg"
		, siteUrl+"images/admin/login/2.jpg"
		, siteUrl+"images/admin/login/3.jpg"
		, siteUrl+"images/admin/login/4.jpg"
	...
	var handleChat = function (elem) {
		var append = function() {
			...
			var msg = '';
				...
				msg +=	'<img class="media-object" alt="Generic placeholder image" src="'+siteUrl+'/images/admin/chat/headshot2.jpg">';
				msg +=  '</a>';
	...
	var handleSliderNav = function () {
		...
		$('#address-book .slider-content ul li ul li a').click(function(e){
			...
			//Set the image
			$('#contact-card .headshot img').attr('src', siteUrl+'images/admin/addressbook/'+img_id+'.jpg');
	...
	var handleThemeSkins = function () {
        ...
        var setSkin = function (color) {
            $('#skin-switcher').attr("href", siteUrl+"/css/admin/themes/" + color + ".css");
		...
		if ($.cookie('gritter_show')) {
            ...
            /*setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    image: siteUrl+'images/admin/gritter/cloud.png',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    // (string | optional) the image to display on the left
                    image: siteUrl+'images/admin/gritter/settings.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    ...
                    // (string | optional) the image to display on the left
                    image: siteUrl+'images/admin/gritter/buy.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
...
*/
	...
	return {
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="../../images/admin/loaders/12.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
